...
### Cat 
Within a dumb shell you can use "cat > output.txt <<EOF" to write outline content to that file (output.txt), and to end the line you can use EOF. You can replace EOF with anything you want just remember to use it to end the line.
